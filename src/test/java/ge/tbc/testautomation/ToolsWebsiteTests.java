...
public class ToolsWebsiteTests {
    private static final Logger log = LoggerFactory.getLogger(ToolsWebsiteTests.class);
    ...
    public void setup() {
        ...
        // რეგისტრაცია ერთხელ
        Page setupPage = browserContext.newPage();
        register(setupPage);
        setupPage.close();
    }
    ...
    public void perTestSetup() {
        ...
        page.navigate(PRACTICE_SOFTWARE_TESTING_LOGIN_URL);
    ...
    public void register(Page page) {
        if (!isUserRegistered) {
            ...
            String password = new StringBuilder(upper + lower + number + special + rest).reverse().toString();
            testEmail = email;
            testPassword = password;

            page.getByPlaceholder("First name *").fill(firstName);
            page.getByPlaceholder("Your last name *").fill(lastName);
            page.getByPlaceholder("Your Date of birth *").click();
